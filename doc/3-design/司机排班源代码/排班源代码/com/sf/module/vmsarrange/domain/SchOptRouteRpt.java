 ...
 *
 */
public class SchOptRouteRpt extends BaseEntity {
	/**
	 * @author 方芳 (350614)
	 * @date 2014-6-16 
	 */
	...
	public String getOptimizeRoute() {
		return optimizeRoute;
	}
	public void setOptimizeRoute(String optimizeRoute) {
		this.optimizeRoute = optimizeRoute;
	}
	public Integer getMatchDays() {
		return matchDays;
	}
	public void setMatchDays(Integer matchDays) {
