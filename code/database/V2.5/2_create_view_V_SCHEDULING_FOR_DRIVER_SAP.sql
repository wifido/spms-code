CREATE OR REPLACE VIEW V_SCHEDULING_FOR_DRIVER_SAP AS
...
D.EMPLOYEE_CODE,D.MODIFIED_TIME,T.SORT,max(d.sync_state) sync_state,max(d.configure_code) configure_code,max(d.id) scheduling_id
