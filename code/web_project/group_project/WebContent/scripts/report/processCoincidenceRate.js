...
var queryButton = new Ext.Button({
    ...
    handler: function() {
        ...
        store.setBaseParam("positionType", "2");
...
addButton('<app:isPermission code = "/report/queryProcessCoincidenceRate.action">a</app:isPermission>', queryButton)
addButton('<app:isPermission code = "/report/exportProcessCoincidenceRate.action">a</app:isPermission>', exportButton)
