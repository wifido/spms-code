...
var queryTraining = function() {
	...
	store.setBaseParam("POST_TYPE","2")
	store.load({
		params: {
			start: 0,
			limit: 20
...
var uploadWindow = new Ext.Window({
	...
	tbar : [{
		...
		handler : function() {
			...
			Ext.getCmp('upload_postType').setValue("2");
...
var tbar = [];
addBar('<app:isPermission code="/warehouse/training_query.action">a</app:isPermission>', btnSearch);
addBar('<app:isPermission code="/warehouse/training_delete.action">a</app:isPermission>', btnDelete);
addBar('<app:isPermission code="/warehouse/training_import.action">a</app:isPermission>', btnImport);
addBar('<app:isPermission code="/warehouse/training_export.action">a</app:isPermission>', btnExport);
