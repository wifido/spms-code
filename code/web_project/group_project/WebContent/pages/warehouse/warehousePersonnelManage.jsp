...
<head>
    ...
    <script type="text/javascript" charset="utf-8" src="../ext-3.4.0/adapter/ext/ext-base.js"></script>
...
<script type="text/javascript" charset="utf-8">
	...
	<%@include file="/scripts/warehouse/addWarehouseEmployee.js"%>
	<%@include file="/scripts/warehouse/warehousePersonnelManage.js"%>
