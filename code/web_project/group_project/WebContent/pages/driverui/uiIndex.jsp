...
<body>
	...
	<div data-role="page" id="page_myScheduling" data-add-back-btn="true">
		<div data-role="header" data-mini="true" data-theme="c">
			...
			<h1>我的排班<s:property value="employee.empCode" /></h1>
		</div>
		<div data-role="content" data-theme="c">
			<div data-role="navbar">
				<ul>
					<li><a href="#" id="prevWeekBtn" data-mini="true">前一周</a></li>
					<li><a href="#" id="currentWeekBtn" data-mini="true">当前周</a></li>
					<li><a href="#" id="nextWeekBtn" data-mini="true">下一周</a></li>
				</ul>
			</div>
			...
			<div data-role="popup" id="revokeLeaveWindow" data-overlay-theme="c" data-theme="c" data-dismissible="false"
				...
				<form id="revokeLeaveForm">
					<div data-role="content" data-theme="c" class="ui-corner-bottom ui-content">
						...
						<a href="#" data-role="button" data-inline="true" data-rel="back" data-theme="c">取消</a> <a href="#"
			...
			<div data-role="popup" id="revokeExchangeSchedulingWindow" data-overlay-theme="c" data-theme="c"
				...
				<form id="revokeExchangeSchedulingForm">
					<div data-role="content" data-theme="c" class="ui-corner-bottom ui-content">
						...
						<a href="#" data-role="button" data-inline="true" data-rel="back" data-theme="c">取消</a> <a href="#"
							id="btnConfirmRevokeExchangeScheduling" data-role="button" data-inline="true" data-rel="back" data-transition="flow" data-theme="b">撤回</a>
					</div>
				</form>
			</div>

			<div data-role="footer" data-theme="c" data-position="fixed">
				<a href="javaScript:confirmScheduling()" data-role="button" data-mini="true" id="btnConfirmScheduling"
					data-icon="check">提交确认</a>
			</div>
		</div>
	</div>
	...
	<div data-role="page" id="selectConfigCode" data-close-btn="none">
		...
		<div data-role="content" data-theme="c" data-mini="true">
			...
			<div data-role="navbar">
				<ul>
					<li><a href="#" id="btnFirstPage" data-mini="true">首页</a></li>
					<li><a href="#" id="btnPrevPage" data-mini="true">上一页</a></li>
					<li><a href="#" id="btnNextPage" data-mini="true">下一页</a></li>
					<li><a href="#" id="btnLastPage" data-mini="true">尾页</a></li>
				</ul>
			</div>
	...
	<div data-role="page" id="commitExchangeSchedulingPage" data-close-btn="none">
		...
		<div data-role="content" data-theme="c" data-mini="true">
			...
			<form id="exchangeSchedulingForm">
				...
				<b> 备注： </b>
				<textarea rows="3" cols="1" name="applyRecord.applyInfo" value="" placeholder="调班原因,非必填"></textarea>
				...
				<a href="javaScript:window.history.go(-3)" data-role="button" data-inline="true" id="cancleCommitBtn">取消</a>
			</form>
		</div>
	</div>
	...
	<div data-role="page" id="optionApprover" data-close-btn="none">
		...
		<div data-role="content" data-theme="c" data-mini="true">
			<div data-role="navbar">
				<ul>
					<li><a href="#" id="homePage" data-mini="true">首页</a></li>
					<li><a href="#" id="pageUp" data-mini="true">上一页</a></li>
					<li><a href="#" id="pageDown" data-mini="true">下一页</a></li>
					<li><a href="#" id="trailerPage" data-mini="true">尾页</a></li>
				</ul>
			</div>
		...
		<div data-role="content">
			<form id="leaveForm">
				<div style="padding: 10px 20px;">
					...
					<a href="javaScript:window.history.go(-2)" data-role="button" data-inline="true" id="cancleCommitBtn">关闭</a>
					<input type="submit" data-inline="true" id="submitLeaveBtn" value="提交">
				</div>
			</form>
		</div>
	</div>
