...
import com.sf.esb.service.bigfileservice.tcasinterface.*;
...
public class BigFileServicePortTypeImpl implements BigFileServicePortType {
    ...
    public static final String RECEIVE_FILE_LOCAL_SAVE_PATH =
            Thread.currentThread().getContextClassLoader().getResource("").getPath() + "receiveHrFile";
    ...
    class FileDownloadHandlerThread extends Thread {
        ...
        public void run() {
            ...
            try {
                String downloadPath = RECEIVE_FILE_LOCAL_SAVE_PATH;
                // 通过报文还原上传策略
                ...
                System.out.println("remote file path is " + param.getRemotePath() + "/" + param.getRemoteFileName());
