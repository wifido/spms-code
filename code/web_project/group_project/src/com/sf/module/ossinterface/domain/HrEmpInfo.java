 ...
 * 
 */
public class HrEmpInfo extends BaseEntity {
	 ...
	 * @date Jun 24, 2014
	 * @param to
	 *            set batchNumber the batchNumber
	 */
	...
	public void setCancelDate(String cancelDate) throws Exception {
		...
		if (this.cancelDate != null && this.cancelDate.trim().length() > 0) {
			this.logoutDt = new SimpleDateFormat("yyyy-MM-dd")
			.parse(this.cancelDate.trim());
		}
	}
	...
	public void setEmpName(String empName) throws Exception {
		this.empName = substring(160, DeCoder.decrypt(empName));
	}
	 ...
	 * @date Jun 23, 2014
	 * @param to
	 *            set positionName the positionName
	 */
