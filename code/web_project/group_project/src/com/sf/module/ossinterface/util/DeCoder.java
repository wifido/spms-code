...
/**
 * HRS提供的解密方法
 * 第一个参数data表示加密字段的密文；第二个参数表示动态密钥，密钥由HRS提供，
 * 目前研发环境使用的密钥是：RocnRwSJF27LqoON+l2A0Q==
 * 生产环境密钥是：iT7C5ILyCAD1Zzk6kKMerg==
...
public class DeCoder {
	...
	public static final Properties cfg = ApplicationContext.getContext().getSystemConfig();
	public static final String KEY = cfg.getProperty("spms.esb.dyncKey");
	//public static final String KEY = "iT7C5ILyCAD1Zzk6kKMerg==";
	/**
	 * 密钥算法
	 */
