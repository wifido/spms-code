...
public abstract class HRSXmlMapping<T> extends DefaultXmlMapping<T> {
	  public static final Logger logger = LoggerFactory.getLogger(HRSXmlMapping.class);
	/**
	 * @author 文俊 (337291)
	 * @date Jun 24, 2014 
	 * @param journalId
	...
	public void attributes(String tagName, Attributes attributes) {
		...
		logger.info(" HRSXmlMapping.attributes() start ");
		...
		logger.info(" HRSXmlMapping.attributes() end ");
	}
}
