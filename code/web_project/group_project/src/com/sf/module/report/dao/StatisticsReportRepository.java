...
public class StatisticsReportRepository {
	...
	public static final String SQL_QUERY_STATISTICS_REPORT_LIST = ""
			...
			+ "                               decode(t.TOTAL_EMP_NUM, 0, 0.1, t.TOTAL_EMP_NUM) * 100),  \n "
			+ "                               0) || '%' SCHEDULING_RATIO, \n "			
			+ " 				   round((t.COM_FULL_ATTENDANCE_NUM /  \n "
			+ "                               decode(t.TOTAL_EMP_NUM, 0, 0.1, t.TOTAL_EMP_NUM) * 100),  \n "
			+ "                               0) || '%' FULL_ATTENDANCE_percent, \n "
			+ " 				   round((t.COM_NOT_FULL_ATTENDANCE_NUM /  \n "
			+ "                               decode(t.TOTAL_EMP_NUM, 0, 0.1, t.TOTAL_EMP_NUM) * 100),  \n "
			+ "                               0) || '%' NOT_FULL_ATTENDANCE_percent, \n "
			+ "   			   round((t.COM_OUT_ATTENDANCE_NUM /  \n "
			+ "                               decode(t.TOTAL_EMP_NUM, 0, 0.1, t.TOTAL_EMP_NUM) * 100),  \n "
			+ "                               0) || '%' OUT_ATTENDANCE_percent, \n "
			+ "                        t.* \n "
