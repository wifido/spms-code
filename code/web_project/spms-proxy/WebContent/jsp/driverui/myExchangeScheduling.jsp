	...
	function loadExchangeScheduling() {
		$.ajax({
			...
			success : function(resp) {
				...
				totalPage = parseInt(result.resultMap.totalSize);
	...
	$(document).on("pagebeforechange", function(e, data) {
		...
		if (typeof url == "string") {
			...
			if (url.indexOf(pageIdOfMyLeaveDetailInfo) != -1) {
				...
				$("#detail_approval_time").html(replaceT(params['APPORVE_TIME']));
	...
	<div data-role="page" id="myExchangeScheduling">
		...
		<div data-role="content">
			<div data-role="navbar" data-grid="c">
				<ul>
					<li><a href="#" class="ui-btn-active" data-mini="true" id="homePage" data-theme="a">首页</a></li>
					<li><a href="#" data-mini="true" id="pageUp" data-theme="a">上一页</a></li>
					<li><a href="#" data-mini="true" id="pageDown" data-theme="a">下一页</a></li>
					<li><a href="#" data-mini="true" id="trailerPage" data-theme="a">尾页</a></li>
				</ul>
			</div>
